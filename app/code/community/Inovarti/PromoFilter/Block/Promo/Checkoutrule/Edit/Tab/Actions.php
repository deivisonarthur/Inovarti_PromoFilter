 ...
 */
class Inovarti_PromoFilter_Block_Promo_Checkoutrule_Edit_Tab_Actions
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $simpleAction = $fieldset->addField('simple_action', 'select', array(
            ...
            'name'      => 'simple_action',
            'options'    => array(
                Inovarti_PromoFilter_Model_Rule::DISABLE_PAYMENT_METHOD => Mage::helper('checkoutrule')->__('Disable payment methods'),
                Inovarti_PromoFilter_Model_Rule::ENABLE_PAYMENT_METHOD => Mage::helper('checkoutrule')->__('Enable payment methods'),
                Inovarti_PromoFilter_Model_Rule::DISABLE_SHIPPING_METHOD => Mage::helper('checkoutrule')->__('Disable shipping methods'),
                Inovarti_PromoFilter_Model_Rule::ENABLE_SHIPPING_METHOD => Mage::helper('checkoutrule')->__('Enable shipping methods'),
            ),
        ));
        ...
        $this->setChild('form_after', $this->getLayout()->createBlock('adminhtml/widget_form_element_dependence')
            ...
            ->addFieldDependence(
                ...
                array(Inovarti_PromoFilter_Model_Rule::DISABLE_PAYMENT_METHOD,
                      Inovarti_PromoFilter_Model_Rule::ENABLE_PAYMENT_METHOD)
            )
            ->addFieldDependence(
                $shippingMethods->getName(),
                $simpleAction->getName(),
                array(Inovarti_PromoFilter_Model_Rule::DISABLE_SHIPPING_METHOD,
                      Inovarti_PromoFilter_Model_Rule::ENABLE_SHIPPING_METHOD)
            )
        );
