<?php
class Inovarti_PromoFilter_Model_Observer
{
    ...
    public function applyRules($observer, $methodType, $methodName)
    {
        ...
        if (!isset($this->_cachedMethodResults[$methodType][$methodName][$quote->getId()])) {
            ...
            /** @var $ruleCollection Inovarti_PromoFilter_Model_Mysql4_Rule_Collection */
    ...
    /**
     * @param $rules Inovarti_PromoFilter_Model_Mysql4_Rule_Collection
    ...
    public function rulesMatch($rules, $quote)
    {
        ...
        foreach ($rules as $rule) {
            /** @var $rule Inovarti_PromoFilter_Model_Rule */
